...
I tend to procrastinate, so I want to have something that I can check off when I get something done. I also want to be able to access this on multiple devices so I can pull it up quickly no matter what I am using. This project is meant to produce a To-Do list that can be updated on the go, resets every night, and is satisfying to use to motivate the completion of tasks.
