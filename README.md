...
## Project Description
A To-Do list with physical buttons to keep track of what the user has gotten done today that also connects to a website so the user can update their list on the go.

## Problem Domain and Motivation
Currently, I live with my girlfriend and we struggle to keep track of if the animals have been fed. I also tend to procrastinate, and having a physical to-do list with actual buttons will make the process of completing a task more fun. This project is meant to produce a To-Do list that can be updated on the go, resets every night, and is physical and satisfying to use to motivate the completion of tasks.
